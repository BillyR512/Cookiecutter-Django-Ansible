...
class Common(Configuration):
    ...
    THIRD_PARTY_APPS = (
        ...
        {% if cookiecutter.install_elasticsearch == "True" %}'haystack',{% endif %}
    )
    ...
    {% if cookiecutter.install_celery == "True"  and cookiecutter.install_rabbitmq == "True" %}
    ...
    {% endif %}
    {% if cookiecutter.install_celery == "True" and cookiecutter.install_redis == "True" %}
        # CELERY CONFIGURATION
    # See: http://docs.celeryproject.org/en/latest/configuration.html#broker-transport
...
class Local(Common):
    ...
    INTERNAL_IPS = ['50.160.141.118', '0.0.0.0', '10.0.2.2', '127.0.0.1']
